...
def main():
    ...
    num_class, args.train_list, args.val_list, args.root_path, prefix = dataset_config.return_dataset(args.dataset,
                                                                                                      args.modality)
    # ---args---
    full_arch_name = '{}_{}_{}'.format(args.model, args.net, args.arch)
    ...
    inputs = torch.rand(args.num_segments, 3, 224, 224)
    ...
    test_batch_size = args.batch_size*3
